            ...
            <h1 id="chr">●●● ⟨ ⁄ ⟩ ●●●</h1>
                ...
                <div className="scrolling-wrapper">
                    <div className="project-detail">
                        <div className="p-1">
                            <h2>SpookyEgg</h2>
                            <a href="https://github.com/jpatnaree/SpookyEgg"><img className="linktogh" src='image/githubrepo.png' alt='link to GitHub' /></a>
                    ...
                    <div className="project-detail">
                        <div className="p-1">
                            <h2>Schmooze</h2>
                            <a href="https://github.com/ian-a-frankel/schmooze"><img className="linktogh" src='image/githubrepo.png' alt='link to GitHub' /></a>
                    ...
                    <div className="project-detail">
                        <div className="p-1">
                            ...
                            <a href="https://github.com/jpatnaree/HayaoMiyazaki"><img className="linktogh" src='image/githubrepo.png' alt='link to GitHub' /></a>
                    ...
                    <div className="project-detail">
                        <div className="p-1">
                            ...
                            <a href="https://github.com/royelaawar/Project-3-Mario"><img className="linktogh" src='image/githubrepo.png' alt='link to GitHub' /></a>
                            <h3>Python Pygame</h3>
                    ...
                    <div className="project-detail">
                        <div className="p-1">
                            ...
                            <a href="https://github.com/KhrystynaKla/Crystal-Harmony-Project"><img className="linktogh" src='image/githubrepo.png' alt='link to GitHub' /></a>
